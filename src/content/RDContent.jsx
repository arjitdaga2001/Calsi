    ...
    <>
      <section className="calc-faq" style={{ marginBottom: '24px' }}>
        ...
        <div style={{ fontSize: '14.5px', color: 'var(--text-secondary)', lineHeight: '1.85' }}>
          ...
          <p style={{ marginBottom: '20px' }}>
            The exact maturity calculation relies on the formula for the future value of an annuity with fractional compounding periods. Attempting to calculate this manually is an exercise in futility, which is why our institutional-grade RD calculator executes these algorithmic iterations instantly, providing you with precision maturity values mapped exactly to Indian banking standards.
          </p>
