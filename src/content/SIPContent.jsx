  ...
  return (
    <>
      ...
      <div style={{ background: 'rgba(59, 130, 246, 0.1)', borderLeft: '4px solid var(--accent-blue)', padding: '16px', margin: '0 auto 24px auto', borderRadius: '4px', maxWidth: '1100px', width: '100%', boxSizing: 'border-box' }}>
        <strong>What does this calculator do?</strong> This SIP Calculator provides instant, institutional-grade estimates for Indian investors and borrowers based on official RBI, SEBI, and Income Tax guidelines.
        <br/><br/>
    ...
    <section className="calc-faq" style={{ marginBottom: '24px' }}>
        ...
        <div style={{ fontSize: '14.5px', color: 'var(--text-secondary)', lineHeight: '1.85' }}>
          ...
          <p style={{ marginBottom: '20px' }}>
            In conclusion, an SIP is not merely a savings plan. It is a highly engineered, mathematically robust framework that merges Rupee Cost Averaging, compounded exponential growth, behavioral discipline, and immense tax efficiency into a single, automated wealth-generation engine. Utilize the parameters in our expert-verified calculator above to model your cash flows, optimize your step-up rates, and architect your blueprint for absolute financial sovereignty.
          </p>
